...
// reportOrphans is invoked by Destroy after tofu destroy completes. It
...
func reportOrphans(ctx context.Context, subscriptionID, projectName string) error {
	...
	return reportOrphansWithClient(ctx, factory.NewClient(), projectName)
}

// reportOrphansWithClient is the unit-testable inner that takes the
// resourcesAPI seam.
func reportOrphansWithClient(ctx context.Context, client resourcesAPI, projectName string) error {
