...
// RegisterClusterProvider registers a cluster provider with the given name.
...
// GetClusterProvider retrieves a cluster provider by name.
...
// ListClusterProviders returns the names of all registered cluster providers.
