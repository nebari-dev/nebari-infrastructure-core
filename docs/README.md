...
5. **[Stateless Operation & Resource Discovery](architecture/06-stateless-operation.md)**
...
6. **[Declarative Infrastructure with Native SDKs](implementation/05-declarative-infrastructure.md)**
